...
import instagram from "../../assets/icons/fill-instagram.png";
import twitter from "../../assets/icons/fill-twitter.png";
import linkedIn from "../../assets/icons/fill-linkedin.png";
...
function TeamSection() {
    return(
        ...
        <div className="flex flex-col items-center lg:p-20 pt-5">
                ...
                <h5 className="text-center lg:text-2xl md:text-1xl sm:text-lg pt-5 font-normal custom-gray-11">Meet our dynamic team of passionate experts, dedicated to creating innovative solutions and fostering positive change in the world</h5>
                </div>

            
            <div className=' grid grid-cols-1 md:grid-cols-3 xl:grid-cols-3 gap-6 pb-20'>
                <div className='team-profile custom-gray-11'>
                    <img src={Ceo} alt="ceo" />
                ...
                <div className='team-profile custom-gray-11'>
                    ...
                    <h3 className='xl:text-3xl md:text-2xl sm:text-lg text-accent-color-main p-2'>Nihinlola Eunice Olowe</h3>
                    <p className='ps-2 xl:text-2xl md:text-2xl sm:text-lg'>Counselling Psychologist</p>
                    <p className='p-2 xl:text-lg md:text-base sm:text-sm'>Empowering growth and well-being through compassionate counseling as a dedicated psychologist</p>
                    <div className='flex gap-5 pt-3'>
                    <Link className="" to=" "target="_blank"><img src={instagram} alt="instagram" /></Link>
                    <Link className="" to=" "target="_blank"><img src={twitter} alt="twitter" /></Link>
                    <Link className="" to=" "target="_blank"><img src={linkedIn} alt="linkedIn" /></Link>
