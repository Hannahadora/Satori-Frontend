        ...
        <div className="mt-[130px]">
            <div className="app-container">
                 <div className="lg:w-[70%] md-[60%] w-full mx-auto">
                    ...
                    <h3 className="lg:text-[26px] md:text-[20px] text-[16px] text-center pt-14">How cookies are used on Satori</h3>
                    <p className="lg:text-[22px] md:text-[18px] text-[16px] text-center pt-4">We use cookies for various purposes including:</p>
                    <p className="lg:text-[22px] md:text-[18px] text-[16px] text-center pt-4"><b>Essential Cookies:</b>These cookies are necessary for the proper functioning of the Website. They enable you to navigate the site and use its features.</p>
                    <p className="lg:text-[22px] md:text-[18px] text-[16px] text-center pt-4"><b>Performance Cookies:</b>These cookies collect anonymous information about how visitors use our Website. They help us analyze and improve the performance of our services.</p>
                    <p className="lg:text-[22px] md:text-[18px] text-[16px] text-center pt-4"><b>Third-party Cookies:</b>Our Website may use third-party services that place cookies on your device. These cookies are subject to the respective privacy policies of these external services providers.</p>
